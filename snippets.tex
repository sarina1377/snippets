...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, boxrule=0pt, sharp corners, enhanced, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
\item
  pip --versioncd
\item
  pip install \#\#\# py -3.10 -m pip install openpyxl( cause I have both
  python 3.9 and 3.10) \#\#\# python -m pip install --upgrade pip
\end{itemize}
